...
jobject createBitmap(JNIEnv *env, Mat src, jobject config){
    ...
    jmethodID mid=env->GetStaticMethodID(java_bitmap_class,"createBitmap","(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;");//获取方法
